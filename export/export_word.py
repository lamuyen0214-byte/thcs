...
class WordExportEngine:
    ...
    def build_matrix_table(doc, exam_data):
        ...
        # SỬA DUY NHẤT: Nâng rows từ 4 lên 5 để bọc vừa đủ chỉ số index hàng r=4 của thầy mà không gây lỗi Out of Range
        ...
        # ĐA VÁ LỖI CHÍ MẠNG OUT OF RANGE: Duyệt trực tiếp qua tập hợp cell thực tế thay vì tọa độ cứng range(11)
