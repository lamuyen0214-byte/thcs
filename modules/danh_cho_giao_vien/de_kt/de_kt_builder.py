...
def render_de_kt_module(api_key=""):
    ...
    st.markdown("""
    # Tinh chỉnh CSS Giao diện: Cứu tiêu đề & đồng bộ màu sắc (Đã bỏ lệnh ép khoảng cách gây sập UI)
    st.markdown("""
    <style>
    ...
    /* 2. LÀM ĐẸP NHÃN (LABELS) ĐỒNG BỘ VỚI PHÂN HỆ KHBD */
    ...
    /* 3. LÀM ĐẸP TIÊU ĐỀ MARKDOWN (Nhận biết, Thông hiểu...) */
    .stMarkdown p strong {
